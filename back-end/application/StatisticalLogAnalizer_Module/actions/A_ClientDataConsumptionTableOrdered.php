<?php
/*
    File        : A_ClientDataConsumptionTableOrdered.php
...
class A_ClientDataConsumptionTableOrdered implements IAction
{
    public function execute()
    {
        ...
        //DATAHANDLERS
        $datahandler = DatahandlerFactory::create('D_ClientDataConsumptionTableOrdered');
        $datahandler->setInData($sessionData);
        ...
        $view = ViewFactory::create('V_ClientDataConsumptionTableOrdered');
        $view->setInData($data);
        $view->display();
    }
}
