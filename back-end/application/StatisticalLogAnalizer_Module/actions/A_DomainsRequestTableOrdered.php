<?php
/*
    File        : A_DomainsRequestTableOrdered.php
...
class A_DomainsRequestTableOrdered implements IAction
{
    public function execute()
    {
        ...
        //DATAHANDLERS
        $datahandler = DatahandlerFactory::create('D_DomainsRequestTableOrdered');
        $datahandler->setInData($sessionData);
        ...
        $view = ViewFactory::create('V_DomainsRequestTableOrdered');
        $view->setInData($data);
        $view->display();
    }
}
