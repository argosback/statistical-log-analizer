...
include_once "back-end/vendors/libchart/libchart/classes/libchart.php";
 ...
 class V_ClientDataLinePlot implements IView, IDataset
 {
     private $data;
     ...
     public function display()
     {
        ...
        {
            $serie1->addPoint(new Point($datum['time'], $datum['client_data']));
        }

        $dataSet = new XYSeriesDataSet();
        $dataSet->addSerie("Client 10.2.210.10 at 15-09-14", $serie1);
